...
const privateRoutes = (
    <>
        <Route path="/" element={<PrivateRoute><LayoutWithSearchBar /></PrivateRoute>}>
            ...
            <Route path="/collections/page/:page" element={<TitleSetter titleKey="publicCollections.title"><CollectionsList /></TitleSetter>} />
            <Route path="/collections/:id/page/:page" element={<TitleSetter titleKey="publicCollections.title"><CollectionView /></TitleSetter>} />
        </Route>
