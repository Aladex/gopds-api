	...
	for _, href := range hostile {
		t.Run(fmt.Sprintf("stripped_%q", href), func(t *testing.T) {
			out := renderPreview(
				...
				paraChunk(0, linkPara(href, "ВИДИМЫЙ ТЕКСТ")),
				nil, testPreviewPolicy(), testPreviewImagePolicy(),
			)
...
func TestRenderChunkHTML_Images(t *testing.T) {
	...
	t.Run("reference to a missing id", func(t *testing.T) {
		out := renderPreview(t, context.Background(), paraChunk(0, imagePara("nope")), nil, testPreviewPolicy(), testPreviewImagePolicy())
		if !strings.Contains(out, "[image]") {
	...
	t.Run("empty href", func(t *testing.T) {
		out := renderPreview(t, context.Background(), paraChunk(0, imagePara("")), nil, testPreviewPolicy(), testPreviewImagePolicy())
	...
	t.Run("one image referenced twice renders twice", func(t *testing.T) {
		...
		out := renderPreview(
			t, context.Background(),
			paraChunk(0, imagePara("dup"), imagePara("dup")),
			binaries, testPreviewPolicy(), testPreviewImagePolicy(),
		)
	...
	t.Run("over the byte limit", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, imagePara("big")), binaries, testPreviewPolicy(), imagePolicy)
	...
	t.Run("over the pixel limit at a small compressed size", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, imagePara("wide")), binaries, testPreviewPolicy(), imagePolicy)
		if strings.Contains(out, "data:image") {
	...
	t.Run("forged header declares millions of pixels", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, imagePara("bomb")), binaries, testPreviewPolicy(), testPreviewImagePolicy())
		if strings.Contains(out, "data:image") {
...
func TestRenderChunkHTML_OutputInvariant(t *testing.T) {
	...
	out := renderPreview(t, context.Background(), chunk, binaries, testPreviewPolicy(), testPreviewImagePolicy())
...
func TestRenderChunkHTML_TextRegressions(t *testing.T) {
	...
	t.Run("table cells and headers", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, table), nil, testPreviewPolicy(), testPreviewImagePolicy())
	...
	t.Run("poem line keeps its wrapper", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, line), nil, testPreviewPolicy(), testPreviewImagePolicy())
	...
	t.Run("poem break and empty line render separators", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, poemBreak, emptyLine), nil, testPreviewPolicy(), testPreviewImagePolicy())
	...
	t.Run("deeply nested formatting renders inside out", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, deep), nil, testPreviewPolicy(), testPreviewImagePolicy())
	...
	t.Run("source attributes other than href are dropped", func(t *testing.T) {
		...
		out := renderPreview(t, context.Background(), paraChunk(0, para), nil, testPreviewPolicy(), testPreviewImagePolicy())
...
func TestRenderChunkHTML_OrdinaryBookRecognizable(t *testing.T) {
	...
	chunks, err := ChunkPreview(
		context.Background(), doc,
		previewImagesFor(context.Background(), doc, testPreviewImagePolicy()),
		testPreviewPolicy(),
	)
	if err != nil {
...
func assertOneAnchorSurvives(t *testing.T, firstID, secondID string) {
	...
	out := renderPreview(t, context.Background(), paraChunk(0, first, second, link), nil, testPreviewPolicy(), testPreviewImagePolicy())
